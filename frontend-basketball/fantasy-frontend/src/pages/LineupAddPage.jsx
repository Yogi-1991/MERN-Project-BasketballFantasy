...
//         const lineupRes = await axios.get(`/data-entry/lineups/check/${matchId}`, {headers: { Authorization: localStorage.getItem('token')}});
...
//             },
//         });
//         setLineupId(lineupRes.data._id); // Save for future update/delete
//     }
//     checkLineup();
// }
//   },[])
...
//     const allPlayers = [
//       ...lineup[teamKey].starters.map(p => p.player),
//       ...lineup[teamKey].substitutions.map(p => p.player),
//     ];

//    const seen = [];
//         for (let playerId of allPlayers) {
//          if (!playerId) continue;
//         if (seen.includes(playerId)) {
...
//     alert('A player cannot be added more than once in starters or subs within the same team.');
//     return;
//   }

//         try {
//             if (lineupId) {
//              await axios.put(`/data-entry/lineups/${lineupId}`, {
//                 gameId: matchId,
//                 teamHome: { team: match.homeTeam._id, ...lineup.teamHome },
//                 teamAway: { team: match.awayTeam._id, ...lineup.teamAway },
//             }, {
//                 headers: { Authorization: localStorage.getItem('token') },
//             });
//             alert('Lineup updated!');
//             } else {
//             await axios.post('/data-entry/lineups', {
//                 gameId: matchId,
//                 teamHome: { team: match.homeTeam._id, ...lineup.teamHome },
//                 teamAway: { team: match.awayTeam._id, ...lineup.teamAway },
//             }, {
...
//       <h2 className="text-2xl font-bold text-orange-600 mb-4">Add Lineups</h2>
...
//                 }
//                 }}
//                 className="text-red-600 underline text-sm mr-4"
//             >
//     Delete Lineup
//   </button>
// )}
...
//   // Fetch existing lineup if it exists
//   useEffect(() => {
//     const checkLineup = async () => {
//       try {
